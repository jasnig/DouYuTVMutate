...
public class NormalAnimator: UIView {
    ...
    public class func loadNormalAnimatorFromNib() -> NormalAnimator {
        return NSBundle.mainBundle().loadNibNamed(String(self), owner: nil, options: nil).first as! NormalAnimator
    }
